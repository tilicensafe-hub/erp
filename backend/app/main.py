...
def delete_customer(customer_id: str, local_id: int | None = None, document: str | None = None, cleanup_duplicates: bool = False) -> dict[str, Any]:
    return _delete_customer_by_identifier(customer_id, local_id, document, cleanup_duplicates)
...
def delete_mobile_customer(customer_id: str, local_id: int | None = None, document: str | None = None, cleanup_duplicates: bool = True, user: dict[str, Any] = Depends(require_seller_session)) -> dict[str, Any]:
    if user["role"] != "admin":
...
def _delete_customer_by_identifier(customer_id: str, local_id: int | None = None, document: str | None = None, cleanup_duplicates: bool = False) -> dict[str, Any]:
    customer = None

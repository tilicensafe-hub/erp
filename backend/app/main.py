...
def _mobile_danfe_pdf(
    ...
    center(margin, y - 9 * mm, left_w, issuer, 9, True)
    center(margin, y - 14 * mm, left_w, settings.nfe_issuer_trade_name or issuer, 7, False)
    ...
    if code128 and _digits_only(access_key):
        ...
        barcode.drawOn(pdf, margin + left_w + middle_w + 4 * mm, y - 18 * mm)

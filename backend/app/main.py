...
def delete_customer(customer_id: str, local_id: int | None = None, document: str | None = None) -> dict[str, Any]:
    return _delete_customer_by_identifier(customer_id, local_id, document)
...
def delete_mobile_customer(customer_id: str, local_id: int | None = None, document: str | None = None, user: dict[str, Any] = Depends(require_seller_session)) -> dict[str, Any]:
    if user["role"] != "admin":
...
def _delete_customer_by_identifier(customer_id: str, local_id: int | None = None, document: str | None = None) -> dict[str, Any]:
    customer = None

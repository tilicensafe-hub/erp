...
- `migrations/004_mobile_sessions.sql`
...
- `POST /mobile/orders`: cria pedido online pelo app vendedor.
- `POST /orders`: cria pedido online pela integracao administrativa.
